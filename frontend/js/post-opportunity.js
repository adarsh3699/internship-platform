document.addEventListener('DOMContentLoaded', () => {
  ...
  if (!user || user.role !== 'organization') { window.location.href = '/login.html'; return; }
  
  document.getElementById('postDeadline').setAttribute('min', new Date().toISOString().split('T')[0]);
});
