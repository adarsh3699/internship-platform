document.addEventListener('DOMContentLoaded', async () => {
  ...
  try {
    ...
    if (!saved.length) {
      document.getElementById('savedContainer').innerHTML = `<div class="empty-state"><div class="empty-icon">💾</div><div class="empty-title">No saved opportunities</div><div class="empty-desc">Browse and save opportunities you like!</div><button class="btn btn-primary" onclick="window.location.href='/opportunities.html'">Browse Now</button></div>`;
      return;
    }
