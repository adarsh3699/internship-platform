document.addEventListener('DOMContentLoaded', async () => {
  ...
  try {
    ...
    if (!apps.length) {
      document.getElementById('appsContainer').innerHTML = `<div class="empty-state"><div class="empty-icon">📭</div><div class="empty-title">No applications yet</div><div class="empty-desc">Start exploring and applying to opportunities!</div><button class="btn btn-primary" onclick="window.location.href='/opportunities.html'">Browse Opportunities</button></div>`;
      return;
    }
